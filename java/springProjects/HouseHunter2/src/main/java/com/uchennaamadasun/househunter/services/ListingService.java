...
public class ListingService {
	...
	//CREATE A LINK
	public Listing addUserToListing(User user, Long id) {
		Listing thisListing = this.viewOne(id);
		thisListing.getUsersWhoHavePostedAboutThisListing().add(user);
		return listingRepository.save(thisListing);
