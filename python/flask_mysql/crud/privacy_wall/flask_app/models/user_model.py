...
from flask_app.models import message_model #(import any models for one-to-many relationship?)
...
class User:
    ...
    def get_by_id(cls, data):
        ...
        WHERE users.id = %(id)s;
        '''
        user = connectToMySQL('privacy').query_db(query, data)
        return cls(user[0])
    ...
    def get_all_users(cls):
        ...
        users_from_db = connectToMySQL('privacy').query_db(query)
        users_list = []
